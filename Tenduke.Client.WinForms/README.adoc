...
The browser form showing the embedded browser can be customized by handling the `RaiseInitializeBrowserForm` event and setting form properties in the event handler. This example changes the form title:
