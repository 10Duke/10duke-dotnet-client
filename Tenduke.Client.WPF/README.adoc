...
The browser window showing the embedded browser can be customized by handling the `RaiseInitializeBrowserWindow` event and setting windows properties in the event handler. This example changes the window title:
